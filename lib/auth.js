...
function getSecret() {
  ...
  if (!s || (typeof s === "string" && s.trim() === "")) {
    ...
    throw new Error("SESSION_SECRET must be set. Do not use default secrets.");
  }
...
/**
 * Require valid admin session. Use at the start of server actions.
 * Throws if not authenticated. Caller should catch and return appropriate error.
